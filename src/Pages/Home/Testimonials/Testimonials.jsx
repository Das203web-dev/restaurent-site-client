...
const Testimonials = () => {
    ...
    return (
        <div className='mx-5 md:w-2/3 md:mx-auto'>
            ...
            <Swiper navigation={true} modules={[Navigation]} className="mySwiper">
                {
                    reviews.map(review => <SwiperSlide
                        key={review._id}
                    >
                        <div className='flex flex-col space-y-3 items-center md:w-1/2 md:mx-auto'>
                            <Rating
                                style={{ maxWidth: 180 }}
                                value={review.rating}
                                readOnly
                            ...
                            <div className='text-center w-3/4'>
                                <p>{review.details}</p>
                                <h3 className='text-3xl uppercase text-orange-500 font-bold'>{review.name}</h3>
                            </div>
                        </div>
                    </SwiperSlide>)
                }
